...
function EditListPage () {
  ...
  useEffect(() => {(async() => {
    {try {
      ...
      .get(
        `http://back.fuseable.monster/api/project/main/read/${userId}/${selectedProjectId}/${selectedNoteId}`
      )
      .then((response) => 
      {
  ...
  const deleteItem = async() =>{
    ...
    try {
      const res = await axios
      .get (
        `http://back.fuseable.monster/api/project/main/delete/${selectedProjectId}/${selectedArrayId}`
      )
      .then ((response) => 
  ...
  const editItem = async(title, content, deadline) => {
    ...
    try {
      const res = await axios
      .post (
        `http://back.fuseable.monster/api/project/main/update/${userId}/${selectedProjectId}/${selectedNoteId}`,
        formData,
      )
      .then ((response) => 
  ...
  const deleteFile = async(fileId) => {
    ...
    try {
      const res = await axios
      .get (
        `http://back.fuseable.monster/api/project/main/mynote/${userId}/${selectedNoteId}/${fileId}`
      )
      .then ((response) => 
        console.log("Edit Response : ", response)
      )
  ...
  const addComment = async() => {
    ...
    if (!comment) {
      ...
      try {
        const res = await axios
        .post(
          `http://back.fuseable.monster/api/comments/${selectedNoteId}`,
          data
        )
        .then((response) => {
  ...
  const deleteComment = async(commentId) => {
    try {
      const res = await axios
      .delete(
        `http://back.fuseable.monster/api/comments/${userId}/${commentId}`
      )
      .then((response) => {
  ...
  const downloadFile = async(downloadFileData) => {
    ...
    try {
      const res = await axios
      .post(
        `http://back.fuseable.monster/api/project/main/note/download`,
        data,
        {responseType: 'blob'}
      )
      .then((response) => {
  ...
  const openGetInviteCode = async() => {
    try {
      const res = await axios
      .get(
        `http://back.fuseable.monster/api/project/invite/${userId}/${selectedProjectId}`
      )
      .then((response) => {
